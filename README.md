...
```bash
cd unet_pipeline
python Train.py experiments/albunet_public/train_config_part0.yaml
python Train.py experiments/albunet_public/train_config_part1.yaml
python Train.py experiments/albunet_public/train_config_part2.yaml
python Train.py experiments/albunet_public/train_config_2nd_stage.yaml
```
...
```bash
cd unet_pipeline
python Inference.py experiments/albunet_public/2nd_stage_inference_config.yaml
```
...
```bash
cd unet_pipeline
python TripletSubmit.py experiments/albunet_public/2nd_stage_submit.yaml
```
